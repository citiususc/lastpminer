...
public class NegacionCompletaPruebaNivel3Test extends PrincipalTestGeneral{

   @Parameters
   public static Collection<Object[]> data(){
      return Arrays.asList(new Object[][] {
            {Algorithms.ALG_NEG_TEST3,  Modes.MODE_BASIC, "apnea", 20, false}, //0
      });
   }

   public NegacionCompletaPruebaNivel3Test(Algorithms algorithm, Modes mode,
