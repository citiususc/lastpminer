...
import source.busqueda.semilla.SemillaConjuncionCEDFE;
...
public class ConcurrenteSemillaConjuncionCEDFE extends SemillaConjuncionCEDFE implements IBusquedaConcurrenteSecuenciaAnotaciones{
   private static final Logger LOGGER = Logger.getLogger(ConcurrenteSemillaConjuncionCEDFE.class.getName());
   ...
   public ConcurrenteSemillaConjuncionCEDFE(String executionId,
   ...
   protected List<Thread> crearHilos(IColeccion coleccion, int tamActual, boolean esSemilla) throws FactoryInstantiationException{
      ...
      if(esSemilla){
         ...
         hiloClassName = "HiloConcurrenteTam5Arbol";
      }
...
//      eventosEliminados.add(new ArrayList<EventoEliminado>());
    ...
    * (non-Javadoc)
    * @see source.busqueda.semilla.SemillaConjuncionDictionaryFinalEvent#posiblesTiposParaAmpliar(java.util.List)
    */
   @Override
   public List<String> posiblesTiposParaAmpliar(List<Patron> actual, List<String> listaTipos){
      return super.posiblesTiposParaAmpliar(actual, listaTipos);
   }
}